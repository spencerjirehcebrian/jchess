...
export function worldToSquare(point: THREE.Vector3, boardFlipped: boolean): Square | null {
...
export function squareToWorld(square: Square, boardFlipped: boolean): THREE.Vector3 {
  let file = square % 8
